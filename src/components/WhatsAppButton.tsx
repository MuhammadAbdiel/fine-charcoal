...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 flex items-center space-x-2 bg-transparent text-white px-3 py-2 rounded-full shadow-lg hover:scale-105 transition-transform"
    >
      {/* Label "Contact Us" */}
